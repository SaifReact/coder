             ...
             <div class="search-area">
               <div class="hero__search__form">
                            <form role="search" name="search" method="post" action="search-result.php">
                                <input type="text" id="searchInput" name="product" placeholder="Search by Product Name, ex-Sony, Casio, ম">
                                <button type="submit" class="site-btn">SEARCH</button>
                                <script src="assets/js/typewrite.js"></script>
                                <script>
                                  new TypeWriter('#searchInput', ['Search by Product Name, ex-Sony, Casio, মাধ্যমিক রসায়ন ', 'Search by Product Name, ex-Sony, Casio, মাধ্যমিক রসায়ন ', 'Search by Product Name, ex-Sony, Casio, মাধ্যমিক রসায়ন '], { writeDelay: 100 });
                                </script>
                            </form>
                        </div>
            </div>
               ...
               <ul class="dropdown-menu">
                  ...
                  <li>
                     ...
                     <div class="clearfix cart-total">
                        ...
                        <div class="clearfix"></div>
                        <a href="cart.php" class="btn btn-upper btn-primary btn-block m-t-20">My Cart</a>	
                     </div>
                     <!-- /.cart-total-->
                  </li>
               </ul>
